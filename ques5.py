...
# Agar user 3 dalega to 6 print karega, 
# 7 dalega toh 5040 print karega aur aise hi dusre numbers ke lie. 
# Note: Abhi ke liye yeh soch lo ki user sirf positive integers hi dalega. 
# Negative integers kabhi nahi dalega.
user_input=int(input("Enter a number"))
i=1
sum=1
while i in range(user_input):
    sum=sum*(i+1)
    i=i+1
print(sum)
